...
// NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
  ...
  #define DELTA_CALIBRATION_DEFAULT_POINTS 9 //CAL 9 Sahlman
#endif
...
#define DELTA_DIAGONAL_ROD_TRIM_TOWER \
  {                                   \
    0.0, 0.0, 0.0                     \
  } //OCTO
...
#define DEFAULT_XYZ_STEPS_PER_UNIT ((XYZ_FULL_STEPS_PER_ROTATION) * (XYZ_MICROSTEPS) / double(XYZ_BELT_PITCH) / double(XYZ_PULLEY_TEETH))
...
#ifdef EXT_E3D_HEMERA
  #define DEFAULT_AXIS_STEPS_PER_UNIT                                                           \
    {                                                                                           \
      DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 389.4 \
  ...
  #define DEFAULT_AXIS_STEPS_PER_UNIT                                                         \
    {                                                                                         \
      DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 415 \
    } // default steps per unit
#endif
...
// Invert the stepper direction. Change (or reverse the motor connector) if an axis goes the wrong way.
  ...
  #ifdef EXT_E3D_HEMERA
    #define INVERT_E0_DIR true //false(T) true(B)
  #else
...
#define GRID_MAX_POINTS_X 12 //CAL Don't use more than 15 points per axis, implementation limited.
#define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
...
// Define in pins QQS-Pro for FLSUN HISPEED board.
